...
int main() {
  ...
  // ASYNC-SAME: task_id=[[INITIAL_TASK_ID]], target_id=[[TARGET_ID_0:[0-9]+]], device_num=[[DEVICE_NUM:[0-9]+]]
  ...
  // ASYNC-SAME: task_id=[[INITIAL_TASK_ID]], target_id=[[TARGET_ID_0]], device_num=[[DEVICE_NUM]]
  // ASYNC-SAME: kind=ompt_target_enter_data, codeptr_ra=(nil)
  ...
  // ASYNC: {{^}}[[THREAD_ID_1]]: ompt_event_target_begin
  // ASYNC-SAME: task_id=[[INITIAL_TASK_ID]], target_id=[[TARGET_ID_1:[0-9]+]], device_num=[[DEVICE_NUM]]
