...
int ompt_initialize(ompt_function_lookup_t lookup, int initial_device_num,
  ...
  register_ompt_callback_t(ompt_callback_target_emi,
                           ompt_callback_target_emi_t);
  register_ompt_callback_t(ompt_callback_target_data_op_emi,
                           ompt_callback_target_data_op_emi_t);
  register_ompt_callback_t(ompt_callback_target_map_emi,
