...
int main() {
  ...
  // ASYNC-DAG: {{^}}[[THREAD_ID:[0-9]+]]: ompt_event_target_emi_begin: task_id=[[INITIAL_TASK_ID]], target_task_id=[[TARGET_TASK_ID]], target_id=[[TARGET_ID_0:[0-9]+]], device_num=[[DEVICE_NUM:[0-9]+]], kind=ompt_target_enter_data, codeptr_ra=(nil)

  // ASYNC-DAG: {{^}}[[THREAD_ID]]: ompt_event_target_emi_end: task_id=[[INITIAL_TASK_ID]], target_task_id=[[TARGET_TASK_ID]], target_id=[[TARGET_ID_0]], device_num=[[DEVICE_NUM]], kind=ompt_target_enter_data, codeptr_ra=(nil)

  // ASYNC-DAG: {{^}}[[THREAD_ID]]: ompt_event_target_emi_begin: task_id=[[INITIAL_TASK_ID]], target_task_id=[[TARGET_TASK_ID]], target_id=[[TARGET_ID_1:[0-9]+]], device_num=[[DEVICE_NUM]], kind=ompt_target_nowait, codeptr_ra=(nil)
