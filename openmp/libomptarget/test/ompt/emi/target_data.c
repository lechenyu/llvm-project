...
int main() {
  ...
  // CHECK-SAME: task_id=[[INITIAL_TASK_ID]], target_task_id=0, target_id=[[TARGET_ID_0:[0-9]+]], device_num=[[DEVICE_NUM:[0-9]+]]
  ...
  // CHECK: {{^}}[[MASTER_ID]]: ompt_event_target_emi_begin
  // CHECK-SAME: task_id=[[INITIAL_TASK_ID]], target_task_id=0, target_id=[[TARGET_ID_1:[0-9]+]], device_num=[[DEVICE_NUM]]
