...
extern int
targetDataEnd(ident_t *loc, DeviceTy &Device, int32_t ArgNum, void **ArgBases,
              void **Args, int64_t *ArgSizes, int64_t *ArgTypes,
              map_var_info_t *arg_names, void **ArgMappers,
              AsyncInfoTy &AsyncInfo OMPT_ARG(bool ForTarget, void *CodePtr),
              bool FromMapper = false);
...
typedef int (*TargetDataFuncPtrTy)(ident_t *, DeviceTy &, int32_t, void **,
                                   ...
                                   map_var_info_t *, void **,
                                   AsyncInfoTy &OMPT_ARG(bool, void *), bool);
