...
struct DeviceTy {
  ...
  int associatePtr(void *HstPtrBegin, void *TgtPtrBegin, int64_t Size OMPT_ARG(void *codeptr));
  int disassociatePtr(void *HstPtrBegin OMPT_ARG(void *codeptr));
  ...
  void *allocData(int64_t Size OMPT_ARG(void *codeptr), void *HstPtr = nullptr,
                  int32_t Kind = TARGET_ALLOC_DEFAULT);
  /// Deallocates memory which \p TgtPtrBegin points at and returns
  /// OFFLOAD_SUCCESS/OFFLOAD_FAIL when succeeds/fails.
  int32_t deleteData(void *TgtPtrBegin OMPT_ARG(void *HstPtrBegin, int64_t Size, void *codeptr));
