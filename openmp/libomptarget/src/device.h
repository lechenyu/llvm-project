...
struct DeviceTy {
  ...
  void *getOrAllocTgtPtr(void *HstPtrBegin, void *HstPtrBase, int64_t Size,
                         ...
                         bool HasCloseModifier, bool HasPresentModifier OMPT_ARG(void *CodePtr));
  void *getTgtPtrBegin(void *HstPtrBegin, int64_t Size);
  void *getTgtPtrBegin(void *HstPtrBegin, int64_t Size, bool &IsLast,
                       bool UpdateRefCount, bool &IsHostPtr,
                       bool MustContain = false);
  int deallocTgtPtr(void *TgtPtrBegin, int64_t Size, bool ForceDelete OMPT_ARG(void *CodePtr),
                    bool HasCloseModifier = false);
  int associatePtr(void *HstPtrBegin, void *TgtPtrBegin, int64_t Size OMPT_ARG(bool OmpRoutine, void *CodePtr));
  int disassociatePtr(void *HstPtrBegin OMPT_ARG(bool OmpRoutine, void *CodePtr));
  ...
  void *allocData(int64_t Size OMPT_ARG(bool OmpRoutine, void *CodePtr), void *HstPtr = nullptr,
                  int32_t Kind = TARGET_ALLOC_DEFAULT);
  /// Deallocates memory which \p TgtPtrBegin points at and returns
  /// OFFLOAD_SUCCESS/OFFLOAD_FAIL when succeeds/fails.
  int32_t deleteData(void *TgtPtrBegin OMPT_ARG(void *HstPtrBegin, int64_t Size, bool OmpRoutine, void *CodePtr));
