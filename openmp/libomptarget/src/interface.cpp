...
EXTERN void __tgt_target_data_begin_internal(ident_t *loc, int64_t device_id,
...
EXTERN void __tgt_target_data_begin(int64_t device_id, int32_t arg_num,
  ...
  TIMESCOPE();
  __tgt_target_data_begin_internal(nullptr, device_id, arg_num, args_base, args,
                                   arg_sizes, arg_types, nullptr, nullptr OMPT_ARG(false, OMPT_GET_RETURN_ADDRESS(0)));
}
...
EXTERN void __tgt_target_data_begin_nowait(int64_t device_id, int32_t arg_num,
  ...
  __tgt_target_data_begin_internal(nullptr, device_id, arg_num, args_base, args,
                                   arg_sizes, arg_types, nullptr, nullptr OMPT_ARG(true, OMPT_GET_RETURN_ADDRESS(0)));
}
...
EXTERN void __tgt_target_data_begin_mapper(ident_t *loc, int64_t device_id,
                                           ...
                                           void **arg_mappers) {
  TIMESCOPE_WITH_IDENT(loc);
  __tgt_target_data_begin_internal(loc, device_id, arg_num, args_base, args,
                                   arg_sizes, arg_types, arg_names, arg_mappers OMPT_ARG(false, OMPT_GET_RETURN_ADDRESS(0)));
...
EXTERN void __tgt_target_data_begin_nowait_mapper(
  ...
  __tgt_target_data_begin_internal(loc, device_id, arg_num, args_base, args,
                                 arg_sizes, arg_types, arg_names, arg_mappers OMPT_ARG(true, OMPT_GET_RETURN_ADDRESS(0)));
}

/// passes data from the target, releases target memory and destroys
/// the host-target mapping (top entry from the stack of data maps)
/// created by the last __tgt_target_data_begin.
EXTERN void __tgt_target_data_end_internal(ident_t *loc, int64_t device_id,
                                         int32_t arg_num, void **args_base,
                                         void **args, int64_t *arg_sizes,
                                         int64_t *arg_types,
                                         map_var_info_t *arg_names,
...
EXTERN void __tgt_target_data_end(int64_t device_id, int32_t arg_num,
                                  ...
                                  int64_t *arg_sizes, int64_t *arg_types) {
  TIMESCOPE();
  __tgt_target_data_end_internal(nullptr, device_id, arg_num, args_base, args,
                               arg_sizes, arg_types, nullptr, nullptr OMPT_ARG(false, OMPT_GET_RETURN_ADDRESS(0)));
}
...
EXTERN void __tgt_target_data_end_mapper(ident_t *loc, int64_t device_id,
                                         ...
                                         void **arg_mappers) {
  TIMESCOPE_WITH_IDENT(loc);
  __tgt_target_data_end_internal(loc, device_id, arg_num, args_base, args,
                               arg_sizes, arg_types, arg_names, arg_mappers OMPT_ARG(false, OMPT_GET_RETURN_ADDRESS(0)));
}
...
EXTERN void __tgt_target_data_update_internal(ident_t *loc, int64_t device_id,
                                            int32_t arg_num, void **args_base,
                                            void **args, int64_t *arg_sizes,
                                            int64_t *arg_types,
                                            map_var_info_t *arg_names,
...
EXTERN void __tgt_target_data_update(int64_t device_id, int32_t arg_num,
                                     ...
                                     int64_t *arg_sizes, int64_t *arg_types) {
  TIMESCOPE();
  __tgt_target_data_update_internal(nullptr, device_id, arg_num, args_base, args,
                                  arg_sizes, arg_types, nullptr, nullptr OMPT_ARG(false, OMPT_GET_RETURN_ADDRESS(0)));
}
...
EXTERN void __tgt_target_data_update_mapper(ident_t *loc, int64_t device_id,
                                            ...
                                            void **arg_mappers) {
  TIMESCOPE_WITH_IDENT(loc);
  __tgt_target_data_update_internal(loc, device_id, arg_num, args_base, args,
                                   arg_sizes, arg_types, arg_names, arg_mappers OMPT_ARG(false, OMPT_GET_RETURN_ADDRESS(0)));
}
...
EXTERN int __tgt_target(int64_t device_id, void *host_ptr, int32_t arg_num,
  ...
  return __tgt_target_internal(nullptr, device_id, host_ptr, arg_num, args_base,
          ...
          OMPT_ARG(false, OMPT_GET_RETURN_ADDRESS(0)));
}
...
EXTERN int __tgt_target_nowait(int64_t device_id, void *host_ptr,
  ...
  return __tgt_target_internal(nullptr, device_id, host_ptr, arg_num, args_base,
                               args, arg_sizes, arg_types, nullptr, nullptr
          OMPT_ARG(true, OMPT_GET_RETURN_ADDRESS(0)));
}
...
EXTERN int __tgt_target_teams_internal(ident_t *loc, int64_t device_id,
...
EXTERN int __tgt_target_teams(int64_t device_id, void *host_ptr,
  ...
  TIMESCOPE();
  return __tgt_target_teams_internal(nullptr, device_id, host_ptr, arg_num,
                                            args_base, args, arg_sizes, arg_types,
                                            nullptr, nullptr, team_num, thread_limit OMPT_ARG(false, OMPT_GET_RETURN_ADDRESS(0)));
}
...
EXTERN int __tgt_target_teams_nowait(int64_t device_id, void *host_ptr,
  ...
  return __tgt_target_teams_internal(nullptr, device_id, host_ptr, arg_num,
                                            args_base, args, arg_sizes, arg_types,
                                            nullptr, nullptr, team_num, thread_limit OMPT_ARG(true, OMPT_GET_RETURN_ADDRESS(0)));
}
...
EXTERN int __tgt_target_teams_mapper(ident_t *loc, int64_t device_id,
  ...
  TIMESCOPE_WITH_IDENT(loc);
  return __tgt_target_teams_internal(loc, device_id, host_ptr, arg_num,
                                            args_base, args, arg_sizes, arg_types,
                                            arg_names, arg_mappers, team_num, thread_limit OMPT_ARG(false, OMPT_GET_RETURN_ADDRESS(0)));
}
...
EXTERN int __tgt_target_teams_nowait_mapper(
  ...
  return __tgt_target_teams_internal(loc, device_id, host_ptr, arg_num, args_base,
                                   args, arg_sizes, arg_types, arg_names,
                                   arg_mappers, team_num, thread_limit OMPT_ARG(true, OMPT_GET_RETURN_ADDRESS(0)));
}
